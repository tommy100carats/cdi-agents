...
| 2026-09-07 | test Hugo | B3 (salaire) à 0 sur 19 offres, C souvent 0 : moyenne 11,9 contre 15,8 avant | contradiction interne (« fourchette plausible » contre « on n'estime jamais ») ; R9 exige une preuve écrite dans l'annonce | à trancher par Tom au premier tour de calibration (R10, R11 candidates) | `rules/criteres.md` § 3 |
| 2026-09-07 | test Hugo | Meilleurtaux noté alors que « diplôme d'ingénieur ou master informatique » exigé | l'exclusion ferme n'est pas vérifiée par du code au sourcing | ajouter un contrôle de motifs d'exclusion dans `pipeline/seniority.py` ou un module `scope.py` | à faire |
